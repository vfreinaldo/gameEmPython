...
janela_aberta = True
pygame.display.set_caption('Fuga de Carro')
...
while janela_aberta:
    ...
    #Detecta colisão
    #if ((x + 65 > pos_x and y + 120 > pos_y_c)):        #Colisão lado direito
        #y = 1200
        
    if ((x + 65 > pos_x - 300 and y + 120 > pos_y)):    #Colisão lado esquerdo
        y = 1200
        
    #if ((x + 65 > pos_x and y + 120 > pos_y_a)):        #Colisão central
        #y = 1200
        
        
    #Criando a movimentação dos outros carros    
    if (pos_y <= -80):                  #Carro da Polícia
        pos_y = randint (800,1000)
        
    if (pos_y_a <= -80):                 #Carro Branco
        pos_y_a = randint (1300,2000)
        
    if (pos_y_c <= -80):                 #Aambulancia
    ...
    pos_y_a -= velocidade_outros + 8    #CARRO BRANCO
    pos_y_c -= velocidade_outros + 4    #AMBULANCIA
